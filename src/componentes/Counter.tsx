...
function Counter() {
    ...
    return (
        <div className={`w-screen text-[#FCFCFD]
            esParm ? "bg-orange-500" "bg-[#3843D0]" 
        ...
        >
            ...
            className={`mt-8 px-6 py2 ${
                esPar ? "text-orange-500" : "text-[3843D0]"
             } border-2 bg-white font-medium rounded-lg hover:bg-[#FCFCFD] transition"`}
            >
                Sumar + 1
            </button>
        </div>
